...

{
    ...
    if (cachedImage) {
        ...
        [requestOperation setDownloadProgressBlock:^(AVURLConnectionOperation *requestOperation, NSUInteger bytesRead, long long totalBytesRead, long long totalBytesExpectedToRead) {
